    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="current"><a href="GegevensBijwerkenLector.php">Persoonlijke gegevens</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<script>
    ...
    $(document).ready(function () {
        $.ajax({
            url: BaseURL+"/lector/" + sessionStorage.getItem('userId'),
            type: "Get",
            dataType: "json",
            async: false,
        ...
        $("#gegevensForm").submit(function () {
            lector.Achternaam = $('#achternaam').val();
            lector.Voornaam = $('#voornaam').val();
            lector.Nummer = $('#nummer').val();
            lector.Telefoonnummer = $('#telefoonnummer').val();
            lector.SchoolMail = $('#schoolemail').val();
            lector.Email = $('#email').val();
            $.ajax({
                url: BaseURL+"/lector/" + sessionStorage.getItem('userId'),
                type: "PUT",
                data: lector,
