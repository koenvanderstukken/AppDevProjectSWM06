    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="current"><a href="homescreenLector.php">Home</a></li>
        ...
        $.ajax({
            ...
            success: function (data) {
                for (var i = 0; i < data.Stagevoorstellen.length; i++) {
                    if (data.Stagevoorstellen[i].Stageopdracht.Status === 1) {
                        ...
                        var status = "In behandeling";
                        $('#table1 tbody').append('<tr class="warning"><td>' + id + '</td><td>' + functie + '</td><td>' + bedrijf + '</td><td>' + plaats + '</td><td>' + status + '</td></tr>')
                    }
                }
            },
